        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10">
                    ...
                    <p data-aos="fade-up" data-aos-delay="200">Kitapların dünyasına açılan kapı: Geniş koleksiyonumuzla bilgiye ve hayal gücüne yolculuk yapın!</p>
                </div>
...
<style>
    ...
    .search-container {
        ...
        border-radius: 25px; /* Köşelerin yuvarlaklığı */
    ...
    .search-button {
        background-color: #e63946; /* Buton rengi */
    ...
    .search-button:hover {
        background-color: #d62839; /* Hover durumu */
    }
