...
<div class="container">
    ...
    <h2>Misyonumuz</h2>
    <p>Çanakkale Onsekiz Mart Üniversitesi Kütüphane ve Dokümantasyon Daire Başkanlığı olarak misyonumuz üniversitenin araştırma, öğrenme ve öğretme amacına hizmet etmek için gereken tüm kaynak ve servisleri temin etmek ve geliştirmektir.</p>
    <h2>Vizyonumuz</h2>
    <p>Bilimsel araştırmanın ve entelektüel sorgulamanın en iyi şekilde yapılmaya çalışıldığı üniversitede öğrenmenin ve araştırmanın vazgeçilmez merkezi olarak bilim ve gelişim konusundaki tüm kaynaklara her yerden erişimi sağlamak ve çağdaş teknolojileri kullanarak sunduğu hizmetlerle alanında öncü bir kurum olmaktır.</p>
</div>
</body>
